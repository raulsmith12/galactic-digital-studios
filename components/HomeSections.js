                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-4 col-sm-6 mb-2">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    With access to the latest tools at our disposal, our team is able to manage any modern database, including MySQL, MongoDB, and PostgreSQL, among others. We not only will help maintain and manage your databases but are able to create fully-dynamic APIs to help fetch and even create content.
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-6 mb-2">
