            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        <h5 className="display-3 text-shadow-1">Need Help with Digital Resources and Development?</h5>
                ...
                <div className="carousel-item">
                    <img src="https://galacticdigitalstudios.com/img/banner-1.jpg" className="d-block w-100" alt="Carousel Banner 1" />
                    <div className="carousel-caption d-none d-md-block">
                        <h5 className="display-3 text-shadow-1">Search Engine Optimization Got You Kerfuffled?</h5>
