...
const Page = () => {
    ...
    const images = [
        { src: "https://galacticdigitalstudios.com/img/syracuse-utah-graphic-design.jpg", alt: "Syracuse Utah graphic design" },
    ...
    return (
        <>
            <MetaHeader
                metatitle = "Syracyse Utah Graphic Design - Galactic Digital Studios"
            ...
            />
            <PageLayout
                title="Syracuse Utah Graphic Design"
                images={images}
                content={content}
                service="graphic"
            />
