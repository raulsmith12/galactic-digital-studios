            ...
            <div className="container-fluid pb-5 mb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-12">
                        ...
                        <p className="h6">If you are looking for t-shirt design, the graphic design team at Galactic Digital Studios can handle this, as well. Your team can wear their brand and personality with pride knowing they&rsquo;re getting high quality t-shirt design. From minimalist elegance to quirky eye-catching graphics, we can create t-shirt designs that showcase your brand&rsquo;s unique personality.</p>
                ...
                <div className="row">
                    ...
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/lehi-utah-graphic-design.webp" width="100%" alt="Lehi Utah Graphic Design" />
                                </div>
                            </div>
                        </div>
                    </div>
