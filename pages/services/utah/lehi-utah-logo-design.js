    ...
    return (
        <>
            <MetaHeader
                ...
                metadesc = "Boost your brand with custom logo design services in Lehi, Utah. Galactic Digital Studios creates unique, impactful logos to make your business stand out."
                    ...
                    <div className="row pt-2">
                        ...
                        <div className="col-md-3 d-none d-md-block">
                            <div className="container-fluid">
                                <div className="row">
                                    <div className="col">
                                        <Image src="https://galacticdigitalstudios.com/img/lehi-utah-logo-design.webp" alt="Lehi Utah logo design" width={0} height={0} style={{ width: "100%", height: "auto" }} />
                                    </div>
                                </div>
                            </div>
                        </div>
