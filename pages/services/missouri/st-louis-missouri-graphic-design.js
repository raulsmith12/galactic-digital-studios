            ...
            <div className="container-fluid pb-5 mb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-12">
                        ...
                        <p className="h6">Build a cohesive brand identity with our comprehensive branding solutions. We'll work with you to develop a brand strategy that resonates with your target audience.</p>
                ...
                <div className="row">
                    <div className="col-md-9 col-sm-12">
                        ...
                        <p className="h6">What sets Galactic Digital Studios apart from the rest? It's not just about designing visuals; it's about creating experiences. Our commitment to innovation and imagination is reflected in every pixel we place and every line we draw. Here's why we're the go-to graphic design business for your St. Louis, Missouri small business.</p>
                        ...
                        <p className="h6">Whether you're a small startup or a large corporation, our services are tailored to suit businesses of all sizes. We adapt our design approach to match the unique requirements of each client.</p>
                        ...
                        <p className="h6">Stellar design shouldn't break the bank. At Galactic Digital Studios, we offer competitive pricing without compromising on the quality of our work. We believe in making top-notch design services accessible to businesses of all sizes.</p>
                        <p className="h6">Embark on a journey of creativity and innovation with Galactic Digital Studios. Whether you're starting from scratch or looking to refresh your brand's image, our team is ready to bring your vision to life. Let's collaborate to create designs that not only meet expectations but exceed them, propelling your brand to new heights in the St. Louis, Missouri business galaxy.</p>
                    ...
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/st-louis-missouri-graphic-design.webp" width="100%" alt="St. Louis Missouri graphic design" />
                                </div>
                            </div>
                        </div>
                    </div>
