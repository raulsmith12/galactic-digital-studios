                ...
                <div className="row pt-2">
                    ...
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/phoenix-arizona-logo-design.jpg" width="100%" alt="Phoenix Arizona logo design" />
                                </div>
                            </div>
                        </div>
                    </div>
