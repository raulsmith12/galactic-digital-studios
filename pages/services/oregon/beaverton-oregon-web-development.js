    ...
    return (
        <>
            <MetaHeader
                ...
                metadesc = "Expert web development services in Beaverton, Oregon. Galactic Digital Studios builds responsive, user-friendly websites tailored to your business needs."
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col pt-5">
                                    <Image src="https://galacticdigitalstudios.com/img/web-development-l.webp" alt="Two monitors with web development code on them" className="mt-5" width={0} height={0} style={{ width: "100%", height: "auto" }} />
                                </div>
                            </div>
                        </div>
                    </div>
