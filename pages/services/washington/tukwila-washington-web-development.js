...
const Page = () => {
    ...
    const images = [
        { src: "https://galacticdigitalstudios.com/img/tukwila-washington-web-development.jpg", alt: "Tukwila Washington web development" },
    ...
    return (
        <>
            ...
            />
            <PageLayout
                title="Tukwila Washington Web Development"
                images={images}
                content={content}
                service="website"
            />
