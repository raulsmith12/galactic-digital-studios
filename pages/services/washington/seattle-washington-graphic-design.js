    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content="https://galacticdigitalstudios.com/services/washington/seattle-washington-graphic-design" />
                ...
                <meta property="twitter:url" content="https://galacticdigitalstudios.com/services/washington/seattle-washington-graphic-design" />
            ...
            <div className="container-fluid pb-5 mb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-12">
                        ...
                        <p className="h5">Among the many great graphic design services that Galactic Digital Studios provides to Seattle, Washington area small businesses is banner design. With banner design services, you will be involved in the creative design process from the beginning. Our team will conduct a questionnaire that will give us a better understanding of what it is you are looking to advertise or convey in your banner, what brand colors you want to use, and how big the banner will be.</p>
                        <p className="h5">Also included in our graphic design services is something that we briefly touched on earlier, which is business card design. Seattle, Washington is considered by many to be the coffee capital of the United States. It is the birthplace of such staples as Starbucks and Seattle&rsquo;s Best. One staple in many small coffee shops is the display of business cards on a wall somewhere. Your business wants - no, needs - a business card that can stand out in any setting, but especially in a coffee shop business card board. Galactic Digital Studios is capable of designing a business card that will not only let potential customers know you mean business, but also will stand out from the crowd.</p>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-9 col-sm-12">
                        <p className="h5">An often-overlooked graphic design service that is starting to catch on with small businesses throughout Seattle, Washington and throughout the United States is sticker design. Our graphic design team will help design a sticker for your business that will give customers the pride and satisfaction of putting it on their water bottles or laptops. And in case the business card board doesn't work out, there&rsquo;s always putting stickers at local small music venues.</p>
                        <h6 className="h5">Galactic Digital Studios stands ready to assist your Seattle, Washington-based small business with their graphic design needs. Use the contact form below or the contact info found on this site to schedule a consultation with one of our graphic design professionals today.</h6>
                    </div>
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/seattle-washington-graphic-design.jpg" width="100%" alt="Seattle Washington graphic design" />
                                </div>
                            </div>
                        </div>
                    </div>
