    ...
    return (
        <>
            <MetaHeader
                ...
                metadesc = "Boost your business with custom web development from Galactic Digital Studios in Olympia, Washington. Innovative, responsive websites tailored to your needs."
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 d-none d-md-block">
                            <div className="container-fluid">
                                <div className="row">
                                    <div className="col">
                                        <Image src="https://galacticdigitalstudios.com/img/olympia-washington-web-development.webp" alt="Olympia Washington web development" width={0} height={0} style={{ width: "100%", height: "auto" }} />
                                    </div>
                                </div>
                            </div>
                        </div>
