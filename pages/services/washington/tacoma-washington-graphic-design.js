                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col text-center">
                                    <img src="https://galacticdigitalstudios.com/img/graphic-design-l.webp" loading="lazy" width="100%" alt="Laptop with trendy graphic design poster behind it" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/tacoma-washington-graphic-design.webp" loading="lazy" width="100%" alt="Tacoma Washington graphic design" />
                                </div>
                            </div>
                        </div>
                    </div>
