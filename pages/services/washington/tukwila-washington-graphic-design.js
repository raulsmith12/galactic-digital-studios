...
const Page = () => {
    ...
    const images = [
        { src: "https://galacticdigitalstudios.com/img/tukwila-washington-graphic-design.jpg", alt: "Tukwila Washington graphic design" },
    ...
    return (
        <>
            ...
            />
            <PageLayout
                title="Tukwila Washington Graphic Design"
                images={images}
                content={content}
                service="graphic"
            />
