    ...
    return (
        <>
            <MetaHeader
                ...
                metadesc = "Expert graphic design services in Denver, Colorado by Galactic Digital Studios. Elevate your brand with stunning visuals that captivate and engage."
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 d-none d-md-block">
                            <div className="container-fluid">
                                <div className="row">
                                    <div className="col">
                                        <Image alt="Denver Colorado graphic design" src="https://galacticdigitalstudios.com/img/denver-colorado-graphic-design.webp" width={0} height={0} style={{ width: "100%", height: "auto" }} />
                                    </div>
                                </div>
                            </div>
                        </div>
