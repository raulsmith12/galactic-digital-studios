...
const Page = () => {
    return (
        <>
            <Head>
                <title>Denver Colorado Logo Design - Galactic Digital Studios</title>
                ...
                <meta name="keywords" content="logo design, Denver, Colorado" />

                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://galacticdigitalstudios.com/services/colorado/denver-colorado-logo-design" />
                <meta property="og:title" content="Denver Colorado Logo Design - Galactic Digital Studios" />
                ...
                <meta property="twitter:url" content="https://galacticdigitalstudios.com/services/colorado/denver-colorado-logo-design" />
                <meta property="twitter:title" content="Denver Colorado Logo Design - Galactic Digital Studios" />
            ...
            <div className="container-fluid pb-5 mb-5">
                ...
                <div className="row pt-2">
                    <div className="col-md-9 col-sm-12">
                        ...
                        <h6 className="h5">For more information on how Galactic Digital Studios can utilize logo design to benefit your Denver, Colorado brand, use the form below or the contact info found on this website to contact one of our logo design representatives today.</h6>
                    </div>
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/denver-colorado-logo-design.jpg" width="100%" alt="Denver Colorado logo design" />
                                </div>
                            </div>
                        </div>
                    </div>
