            ...
            <div className="container-fluid pb-5 mb-5">
                ...
                <div className="row pt-2">
                    <div className="col-md-9 col-sm-12">
                        ...
                        <p className="h5">Explore our portfolio to witness the diverse range of logos we&rsquo;ve crafted for businesses across Boulder and beyond. Our commitment to excellence, creativity, and client satisfaction sets us apart as the go-to logo design agency in Boulder, Colorado.</p>
                        <h6 className="h5">Ready to elevate your brand with a captivating logo? Use the contact form below or the contact information on our site and contact Galactic Digital Studios, where innovation meets identity, and let&rsquo;s create something extraordinary together.</h6>
                    </div>
                    <div className="col-md-3 d-none d-md-block">
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col">
                                    <img src="https://galacticdigitalstudios.com/img/boulder-colorado-logo-design.jpg" width="100%" alt="Boulder Colorado logo design" />
                                </div>
                            </div>
                        </div>
                    </div>
